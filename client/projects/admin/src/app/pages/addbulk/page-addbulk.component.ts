...
@Component({
  selector: 'app-page-addbulk',
  templateUrl: './page-addbulk.component.html',
  styleUrls: ['./page-addbulk.component.scss']
})
export class PageAddbulkComponent implements OnInit {
  bulkForm;
