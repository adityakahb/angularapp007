...
@Component({
  selector: 'app-page-manage-sellers',
  templateUrl: './page-manage-sellers.component.html',
  styleUrls: ['./page-manage-sellers.component.scss']
})
export class PageManageSellersComponent implements OnInit {
  __EMAIL: FormControl;
