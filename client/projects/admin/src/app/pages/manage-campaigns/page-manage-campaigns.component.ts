...
@Component({
  selector: 'app-page-manage-campaigns',
  templateUrl: './page-manage-campaigns.component.html',
  styleUrls: ['./page-manage-campaigns.component.scss']
})
export class PageManageCampaignsComponent implements OnInit {
  __EMAIL: FormControl;
