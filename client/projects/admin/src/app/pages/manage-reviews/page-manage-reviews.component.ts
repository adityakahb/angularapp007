...
@Component({
  selector: 'app-page-manage-reviews',
  templateUrl: './page-manage-reviews.component.html',
  styleUrls: ['./page-manage-reviews.component.scss']
})
export class PageManageReviewsComponent implements OnInit {
  __EMAIL: FormControl;
