...
@Component({
  selector: 'app-page-manage-products',
  templateUrl: './page-manage-products.component.html',
  styleUrls: ['./page-manage-products.component.scss']
})
export class PageManageProductsComponent implements OnInit {
  __EMAIL: FormControl;
